...
export async function listPublishers(req: express.Request, res: express.Response) {
...
export async function fetchPublisher(req: express.Request, res: express.Response) {
